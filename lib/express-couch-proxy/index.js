...
module.exports = function(options, cb) {
  ...
  //  TripOtt:  auth0 handles authentication. Dont need to parse credentials from Authorization header.
  //   commented middleware from original library.

  // parse credentials from Authorization header into req.remote_*
  // app.use(function(req, res, next) {
  //   //console.log("PROXY REQUEST", req)
  //   console.log("proxy auth header", req.headers['authorization'])
